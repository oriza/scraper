defmodule Scraper do
  ...
  defdelegate scrape_archive(http_client, html_parser, url, selectors),
    to: Scraper.Archive,
    as: :scrape

  defdelegate scrape_article(http_client, html_parser, url, selectors),
    to: Scraper.Article,
    as: :scrape
  ...
  defdelegate scrape_rss(http_client, html_parser, url), to: Scraper.Rss, as: :scrape
